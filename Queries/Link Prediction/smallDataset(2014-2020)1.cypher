...
// ADDITIONAL STEPS FOR COMMUNITY DETECTION
...
// Step2. Running community detection algorithm
...
CALL gds.graph.project(
  ...
  {
    nodeProperties: ['community']  // Include community as node property
  }
)
...
// Prediction
CALL gds.beta.pipeline.linkPrediction.predict.stream("CitationProjection", {
    modelName: "lp-pipeline-model",  // Fixed missing closing quote
    writeRelationshipType: "PREDICTED_CITATION",
    topN: 2
